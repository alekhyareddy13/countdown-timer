...
class CountDown:
    def __init__(self, root):
        ...
        # inside this frame
        self.button_frame = Frame(self.window, bg="orange", width=240, height=40)
        self.button_frame.place(x=230, y=150)
        # This frame is used to show the countdown time label
        self.time_frame = Frame(self.window, bg="orange", width=480, height=120).place(x=0, y=210)

        # Tkinter Labels
        time_label = Label(self.window, text="Set Time", font=("times new roman", 20, "bold"), bg='lavender', fg='black')
        time_label.place(x=180, y=30)

        hour_label = Label(self.window, text="Hour",
                           font=("times new roman", 15), bg='lavender', fg='black')
        ...
        # Tkinter Buttons
        # Cancel button
        cancel_button = Button(self.window, text='Exit',
    ...
    def start_time(self):
        ...
        while self.time_left > 0:
            ...
            if self.time_left <= 0:
                pygame.mixer.music.load('Ringtones/alarm.mp3')
